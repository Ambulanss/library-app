...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_1_3.setPlaceholderText("Nazwisko")
        ...
        self.lineEdit_1_5.setPlaceholderText("Miasto")
        ...
        self.lineEdit_1_6.setPlaceholderText("Powiat")
        ...
        self.lineEdit_1_8.setPlaceholderText("Numer")
        ...
        self.lineEdit_1_9.setPlaceholderText("Ulica")
        ...
        self.lineEdit_1_10.setPlaceholderText("Kod pocztowy")
        ...
        self.formLayout_3.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.label)
        self.label_5 = QtWidgets.QLabel(self.tab_3)
        self.label_5.setObjectName("label_5")
        self.formLayout_3.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.label_5)
        self.lineEdit_1_7 = QtWidgets.QComboBox(self.tab_3)
        self.lineEdit_1_7.setObjectName("lineEdit_1_7")
        self.lineEdit_1_7.addItem("")
        self.lineEdit_1_7.addItem("")
        self.lineEdit_1_7.addItem("")
        self.lineEdit_1_7.addItem("")
        self.lineEdit_1_7.addItem("")
        ...
        self.lineEdit_1_11 = QtWidgets.QComboBox(self.tab_3)
        self.lineEdit_1_11.setObjectName("lineEdit_1_11")
        self.formLayout_3.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.lineEdit_1_11)
        ...
        self.registerSearchLabelsLayout.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        ...
        self.tableView_5.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.borrowEdit = QtWidgets.QLineEdit(self.tab_5)
        self.borrowEdit.setMaxLength(11)
        self.borrowEdit.setObjectName("borrowEdit")
        self.formLayout_8.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.borrowEdit)
        self.borrowEdit_1 = QtWidgets.QLineEdit(self.tab_5)
        self.borrowEdit_1.setInputMethodHints(QtCore.Qt.ImhDigitsOnly)
        self.borrowEdit_1.setObjectName("borrowEdit_1")
        self.formLayout_8.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.borrowEdit_1)
        self.borrowEdit_2 = QtWidgets.QSpinBox(self.tab_5)
        self.borrowEdit_2.setProperty("value", 21)
        self.borrowEdit_2.setObjectName("borrowEdit_2")
        self.formLayout_8.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.borrowEdit_2)
        ...
        self.returnEdit = QtWidgets.QLineEdit(self.tab_9)
        self.returnEdit.setObjectName("returnEdit")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.returnEdit)
        self.gridLayout_12.addLayout(self.formLayout_2, 0, 0, 1, 1)
        self.returnButton = QtWidgets.QPushButton(self.tab_9)
        self.returnButton.setObjectName("returnButton")
        self.gridLayout_12.addWidget(self.returnButton, 1, 0, 1, 1)
        ...
        self.lineEdit_11 = QtWidgets.QSpinBox(self.tab_6)
        self.lineEdit_11.setProperty("value", 7)
        ...
        self.addButton_2 = QtWidgets.QPushButton(self.tab)
        self.addButton_2.setObjectName("addButton_2")
        self.gridLayout_4.addWidget(self.addButton_2, 1, 0, 1, 1)
        ...
        self.formLayout_6.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.lineEdit)
        ...
        self.formLayout_6.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_31)
        ...
        Form.setTabOrder(self.lineEdit_1_3, self.lineEdit_1_5)
        Form.setTabOrder(self.lineEdit_1_5, self.lineEdit_1_6)
        Form.setTabOrder(self.lineEdit_1_6, self.lineEdit_1_8)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_6.setText(_translate("Form", "1.Pesel*"))
        self.label_7.setText(_translate("Form", "2.Imię*"))
        self.label_8.setText(_translate("Form", "3.Nazwisko*"))
        self.label_9.setText(_translate("Form", "4.Data urodzenia*"))
        self.label_10.setText(_translate("Form", "5.Miasto*"))
        self.label_11.setText(_translate("Form", "6.Powiat*"))
        self.label_14.setText(_translate("Form", "7.Województwo*"))
        self.label_15.setText(_translate("Form", "8.Numer lokalu*"))
        self.label_16.setText(_translate("Form", "9.Ulica*"))
        self.label_17.setText(_translate("Form", "10.Kod pocztowy*"))
        self.label.setText(_translate("Form", "* - pole obowiązkowe"))
        self.label_5.setText(_translate("Form", "11.Filia*"))
        self.lineEdit_1_7.setItemText(0, _translate("Form", "Dolnośląskie"))
        self.lineEdit_1_7.setItemText(1, _translate("Form", "Kujawsko-pomorskie"))
        self.lineEdit_1_7.setItemText(2, _translate("Form", "Lubelskie"))
        self.lineEdit_1_7.setItemText(3, _translate("Form", "Lubuskie"))
        self.lineEdit_1_7.setItemText(4, _translate("Form", "Łódzkie"))
        self.lineEdit_1_7.setItemText(5, _translate("Form", "Małopolskie"))
        self.lineEdit_1_7.setItemText(6, _translate("Form", "Mazowieckie"))
        self.lineEdit_1_7.setItemText(7, _translate("Form", "Opolskie"))
        self.lineEdit_1_7.setItemText(8, _translate("Form", "Podkarpackie"))
        self.lineEdit_1_7.setItemText(9, _translate("Form", "Podlaskie"))
        self.lineEdit_1_7.setItemText(10, _translate("Form", "Pomorskie"))
        self.lineEdit_1_7.setItemText(11, _translate("Form", "Śląskie"))
        self.lineEdit_1_7.setItemText(12, _translate("Form", "Świętokrzyskie"))
        self.lineEdit_1_7.setItemText(13, _translate("Form", "Warmińsko-mazurskie"))
        self.lineEdit_1_7.setItemText(14, _translate("Form", "Wielkopolskie"))
        self.lineEdit_1_7.setItemText(15, _translate("Form", "Zachodniopomorskie"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("Form", "Zarejestruj użytkownika w filii"))
        ...
        self.borrowEdit.setPlaceholderText(_translate("Form", "PESEL"))
        self.borrowEdit_1.setPlaceholderText(_translate("Form", "Numer egzemplarza"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_5), _translate("Form", "Wypożycz"))
        self.label_4.setText(_translate("Form", "Numer egzemplarza"))
        self.returnButton.setText(_translate("Form", "Zwróć egzemplarz"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_9), _translate("Form", "Zwróć"))
        ...
        self.label_38.setText(_translate("Form", "Dni do wygaśnięcia rezerwacji"))
        self.lineEdit_9.setPlaceholderText(_translate("Form", "PESEL"))
        self.lineEdit_10.setPlaceholderText(_translate("Form", "Numer egzemplarza"))
        ...
        self.addButton_2.setText(_translate("Form", "Dodaj"))
        self.label_22.setText(_translate("Form", "Tytuł*"))
        self.lineEdit_2.setPlaceholderText(_translate("Form", "Tytuł"))
        self.label_23.setText(_translate("Form", "Imię autora*"))
        self.lineEdit_3.setPlaceholderText(_translate("Form", "Imię"))
        self.label_24.setText(_translate("Form", "Nazwisko autora*"))
        self.lineEdit_4.setPlaceholderText(_translate("Form", "Nazwisko"))
        self.label_26.setText(_translate("Form", "Numer filii*"))
        self.lineEdit.setPlaceholderText(_translate("Form", "Numer filii"))
